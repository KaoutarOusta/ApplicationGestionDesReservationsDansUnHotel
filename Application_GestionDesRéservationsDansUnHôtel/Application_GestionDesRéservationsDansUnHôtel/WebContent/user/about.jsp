		...
		<div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
			<div class="w3-half w3-margin-bottom">
				<div class="w3-display-container">
					<img src="../images/cinqueterre.jpg" alt="moulay idriss zerhoun"
						style="width: 100%"> <span
						class="w3-display-bottomleft w3-padding">moulay idriss zerhoun</span>
				</div>
			</div>
			<div class="w3-half">
				<div class="w3-row-padding" style="margin: 0 -16px">
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
							<img src="../images/newyork2.jpg" alt="marrakech"
								style="width: 100%"> <span
								class="w3-display-bottomleft w3-padding">marrakech</span>
						</div>
					</div>
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
							<img src="../images/sanfran.jpg" alt="chefchaouen"
								style="width: 100%"> <span
								class="w3-display-bottomleft w3-padding">chefchaouen</span>
						</div>
					</div>
				</div>
				<div class="w3-row-padding" style="margin: 0 -16px">
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
							<img src="../images/pisa.jpg" alt="Rabat" style="width: 100%">
							<span class="w3-display-bottomleft w3-padding">Rabat</span>
						</div>
					</div>
					<div class="w3-half w3-margin-bottom">
						<div class="w3-display-container">
